        ...
        if (mysqli_num_rows($q)==0) {
            ...
            if (mysqli_num_rows($q)==1) {
                ...
                if ($nickname==$password) {
                    $pesan_login = '<div class="alert alert-danger">Maaf, nickname dan password tidak tepat. <hr>Gunakan fitur lupa password jika kamu lupa!</div>';
                } else {
                    $pesan_login = '<div class="alert alert-danger">Maaf, nickname dan password tidak tepat. <hr>Gunakan username NIM dan password = NIM jika pertama kali menggunakan QWars </div>';
                }
            }
        }
    }
