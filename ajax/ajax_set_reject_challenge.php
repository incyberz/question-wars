...
if(!isset($_GET['tipe_btn'])) die(erjx(5)); $tipe_btn = $_GET['tipe_btn'];
if(trim($tipe_btn)=="") die("Error @ajax. SQL Values Data #5 is empty.");

if(!isset($_GET['score_for_player'])) die(erjx(6)); $score_for_player = $_GET['score_for_player'];
if(!isset($_GET['gm_comment'])) die(erjx(7)); $gm_comment = $_GET['gm_comment'];

$gm_comment = "'$gm_comment'";

if($tipe_btn=="btn_reject" and $score_for_player>0) $score_for_player=0;
...
$pesan = "Reject"; if($tipe_btn=="btn_set") $pesan = "Set Reward";
echo "1__$pesan Submit Challenge dari player sukses.__$score_for_player";
?>
